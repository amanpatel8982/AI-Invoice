...
// generate unique invoice number to avoid conflicts in the database for new invoices number
...
export async function getInvoiceById (req, res) {
    try {
        ...
        const {Id} = req.params;
        let inv;
        if(isObjectIdString(Id)) inv = await Invoice.findOne(Id);
