...
const IconComponent = StatusIcons[config.icon] || StatusIcons.draft;
  ...
  return (
    ...
    ${config.bg} ${config.text} border ${config.border} transition-all duration-300 ease-out hover:scale-105
    hover:shadow-sm group relative overflow-hidden
    `}>
        <div className={`absolute insert-0 bg-linear-to-r ${config.gradient} opacity-0
