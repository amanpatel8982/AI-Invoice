...
const Navbar = () => {
  ...
  // keep the localStorage token in the syno with clerk auth state
...
//after successfull login rediect us to dashboard
    ...
    <header className={navbarStyles.header}>
      ...
      <div className={`${open ? "block" : "hidden"} ${navbarStyles.mobileMenu}`}>
        <div className={navbarStyles.mobileMenuContainer}>
          <a href="#feature" className={navbarStyles.mobileNavLink}>
            Features
          </a>
